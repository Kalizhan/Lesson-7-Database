...
//        list.add("2e");
//        list.add("3e");
//        ArrayAdapter<String> adapter = new ArrayAdapter<String>(this, R.layout.item_group, list);
    ...
    public void initSpinner1(){
        ...
        if (cursor != null && cursor.getCount() > 0){
            while(cursor.moveToNext()){
                String univerName = cursor.getString(cursor.getColumnIndex(COLUMN_UNIVERSITY));
        ...
        switch(v.getId()){
            case R.id.btnCreateAccount:
                ...
                if (createAccount){
                    ...
                    sqLiteDatabase.insert(TABLE_STUDENTS, null, userValues);
